...
--
-- Host: localhost
-- Generation Time: Nov 13, 2014 at 09:50 PM
...
(3, 'Today I spent time designing designing a decent way to present the projects I have worked on on a top level view.  I came up with the idea for a simple title-image scheme to keep it minimal.  Additional information can be found on projects by clicking on the project boxes.  All of this information is currently stored in the database, but I think I will need to figure out a more elegant solution for creating templates for the projects page.\n<br><Br>\nThere is still some more work left to do: \n<ul>\n<li>Redesign navigation bar</li>\n<li>Reread text on About page</li>\n<li>Make it mobile friendly</li>\n<li>The date on a news post needs to be fixed</li>\n<li><s>Add remaining projects</s></li>\n<li><s>Redesign the style of the content of the project page (I don''t like the content displayed over the background)</s></li>\n<li><S>Change the Title</s></li>\n<li><s>Upload site source to GitHub</s></li>\n<li><s>Order posts by date desc</s></li>\n<li><s>Add order to projects</s></li>\n<li><s>Create simple CMS for editing the HTML</s></li>\n</ul>', 'Added the Projects', '2014-11-14 04:30:51'),
(9, 'PhpMyAdmin is extraordinary convenient.  You literally just need to unzip the package into your apache webserver and it is ready to go.  Since everything is stored on the database and fetched using AJAX, I used a lot of PhpMyAdmin to get some initial data inserted.\n<br><br>\nObviously, this was a temporary solution, and I knew I would definitely need to implement some type of CMS for my site in order for me to not be fed up with manually inserting rows into the database.  Manually writing SQL statements gets way to tedious.\n<br><br>\nI managed to create a rudimentary CMS system which allows me to add posts (the ones you see on this screen now), add new projects, and update the about page.  This is all done from the website itself, and it is very convenient.  Expect a video soon demonstrating this feature!\n<br><br>\nOther than that large portion of work, I knocked out a couple of minor tasks tonight as I listened to some soothing liquid drum and bass mixes on YouTube.  Here is an excellent mix <a href="https://www.youtube.com/watch?v=UQJlx0ffLYo" target="_blank">https://www.youtube.com/watch?v=UQJlx0ffLYo</a>', 'A Custom CMS', '2014-11-14 04:49:32');
...
(59, 'NN Stock Trainer', 'images/programming/nnstock.png', '<div class="goodies">     <div class="center">         <span class="title">NN Stock Trainer</span>         <br><br>         <img src="images/programming/nnstock.png" class="small">         <br><br>     </div>      <b>Description</b>:     <br>     This was a larger project I worked on for downloading stock prices from YAHOO, storing them in a MySQL database, run distributed neural network training using that data utilizing the various old computers I had laying around my house, and ultimatley predicting stock prices for the future 5 days.     <br><br>     This project works in a couple of steps.  The first part of the application is the downloader which downloads unseen days from YAHOO''s stock history API.  Yahoo allows the export of .CSV files of their stock history; therefore, this downloader parses those files to extract the data and insert them into a MySQL database.     <br><br>     The second part of the project is the training.  On various machines, the training service is constantly running listening for "train" messages off a load balanced queue in an ActiveMQ broker (JMS).  Once it obtains one, it will start training, and once done, it will publish a "result" message to another queue which the stock writer service is listening to to write the results to the MySQL database.     <br><br>     The final part of this project consisted of the predicting service.  This service listened onto a "predict" queue.  Once it receives a "predict" message, it will use the historial stock data from the database and the parameters of the trained neural network to try and predict the future stock prices.     <br><br>     This never actually ended up predicting stock prices accuraley, but created the system was a fun learning experience.     <br><br>     <b>Technologies Used</b>:     <br>Java     <br>ActiveMQ (JMS)     <br>MySQL     <br>OpenCSV (CSV Parsing Java Library)     <br>Encog (Neural Network Java Library)     <br><br><br>      <a href="https://github.com/codyseibert/NNStockTrainer" target="_blank"><img src="images/github.png" class="github"> GitHub</a>  </div>', 'programming', 8),
(9, 'Rooster', 'images/art/rooster_sketch.jpg', '<img src="images/art/rooster_sketch.jpg">', 'art', -10),
(10, 'Fallout 3', 'images/art/fallout_sketch.jpg', '<img src="images/art/fallout_sketch.jpg">', 'art', 0),
(11, 'Alien', 'images/art/alien_sketch.jpg', '<img src="images/art/alien_sketch.jpg">', 'art', 10),
(12, 'Baneling', 'images/art/baneling_sketch.jpg', '<img src="images/art/baneling_sketch.jpg">', 'art', 0),
(13, 'Butterfly', 'images/art/butterfly_mm.jpg', '<img src="images/art/butterfly_mm.jpg">', 'art', 0),
(14, 'Charlotte', 'images/art/charlotte_sketch.jpg', '<img src="images/art/charlotte_sketch.jpg">', 'art', 0),
(15, 'Chattanooga Art Museum', 'images/art/chatty_sketch.jpg', '<img src="images/art/chatty_sketch.jpg">', 'art', -10),
(16, 'Elite', 'images/art/elite_sketch.jpg', '<img src="images/art/elite_sketch.jpg">', 'art', 5),
(17, 'Eye #1', 'images/art/eye_sketch.jpg', '<img src="images/art/eye_sketch.jpg">', 'art', 0),
(18, 'Hei', 'images/art/hei_sketch.jpg', '<img src="images/art/hei_sketch.jpg">', 'art', 7),
(19, 'Hell Knight', 'images/art/hellknight_sketch.jpg', '<img src="images/art/hellknight_sketch.jpg">', 'art', 10),
(20, 'Horse', 'images/art/horse_sketch.jpg', '<img src="images/art/horse_sketch.jpg">', 'art', -10),
(21, 'Hydralisk', 'images/art/hydralisk_sketch.jpg', '<img src="images/art/hydralisk_sketch.jpg">', 'art', 4),
(22, 'Isaac, Dead Space', 'images/art/isaac_cp.jpg', '<img src="images/art/isaac_cp.jpg">', 'art', 0),
(23, 'Joker', 'images/art/joker_sketch.jpg', '<img src="images/art/joker_sketch.jpg">', 'art', 0),
(24, 'Kick-Ass', 'images/art/kickass_sketch.jpg', '<img src="images/art/kickass_sketch.jpg">', 'art', 0),
(25, 'Lightning, FF XIII', 'images/art/lightning_sketch.jpg', '<img src="images/art/lightning_sketch.jpg">', 'art', 7),
(26, 'Majora''s Mask', 'images/art/mask_cp.jpg', '<img src="images/art/mask_cp.jpg">', 'art', 0),
(27, 'Megaman', 'images/art/megaman_cp.jpg', '<img src="images/art/megaman_cp.jpg">', 'art', 0),
(28, 'Orc, Warcraft 3', 'images/art/orc_sketch.jpg', '<img src="images/art/orc_sketch.jpg">', 'art', 0),
(29, 'Skull', 'images/art/skull_sketch.jpg', '<img src="images/art/skull_sketch.jpg">', 'art', 0),
(30, 'Slasher, Dead Space', 'images/art/slasher_da.jpg', '<img src="images/art/slasher_da.jpg">', 'art', 0),
(31, 'Stalker, Dead Space', 'images/art/stalker_ds_sketch.jpg', '<img src="images/art/stalker_ds_sketch.jpg">', 'art', 10),
(32, 'Strider', 'images/art/strider_sketch.jpg', '<img src="images/art/strider_sketch.jpg">', 'art', 0),
(33, 'Sunflower', 'images/art/sunflower_sketch.jpg', '<img src="images/art/sunflower_sketch.jpg">', 'art', 0),
(34, 'Tank, L4D', 'images/art/tank_sketch.jpg', '<img src="images/art/tank_sketch.jpg">', 'art', 0),
(35, 'Tychus, Starcraft 2', 'images/art/tychus_sketch.jpg', '<img src="images/art/tychus_sketch.jpg">', 'art', 8),
(36, 'Ultralisk', 'images/art/ultralisk_sketch.jpg', '<img src="images/art/ultralisk_sketch.jpg">', 'art', 0),
(37, 'V for Vendetta', 'images/art/v_mm.jpg', '<img src="images/art/v_mm.jpg">', 'art', 0),
(38, 'Christopher Walken', 'images/art/walken_sketch.jpg', '<img src="images/art/walken_sketch.jpg">', 'art', 7),
(39, 'Zombie, Half Life', 'images/art/zombie_sketch.jpg', '<img src="images/art/zombie_sketch.jpg">', 'art', 0),
(40, 'To Zanarkand - Final Fantasy X Piano Collections', 'images/music/zanarkand.jpg', '<iframe width="560" height="315" src="//www.youtube.com/embed/4U9RhvUpXnQ?list=UUsrVDPJBYeXItETFHG0qzyw" frameborder="0" allowfullscreen></iframe>', 'music', 0),
(41, 'Merry Christmas Mr. Lawrence', 'images/music/christmas.jpg', '<iframe width="560" height="315" src="//www.youtube.com/embed/kQQjMnV33bo?list=UUsrVDPJBYeXItETFHG0qzyw" frameborder="0" allowfullscreen></iframe>', 'music', 0),
(42, 'Attack - Final Fantasy X Piano Collections', 'images/music/attack.jpg', '<iframe width="560" height="315" src="//www.youtube.com/embed/U8afzMa_HLs?list=UUsrVDPJBYeXItETFHG0qzyw" frameborder="0" allowfullscreen></iframe>', 'music', 0),
(43, 'Besaid Island - Final Fantasy X Piano Collections', 'images/music/besaid.jpg', '<iframe width="560" height="315" src="//www.youtube.com/embed/lAJCsE7M7V8?list=UUsrVDPJBYeXItETFHG0qzyw" frameborder="0" allowfullscreen></iframe>', 'music', 0),
(44, 'Via Purifico - Final Fantasy X Piano Collections', 'images/music/via_perfecto.jpg', '<iframe width="560" height="315" src="//www.youtube.com/embed/1Ni0KqYPZpo?list=UUsrVDPJBYeXItETFHG0qzyw" frameborder="0" allowfullscreen></iframe>', 'music', 0),
(45, 'The Forest of Pink', 'images/music/pink.jpg', '<iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/176519745&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>', 'music', 0),
(46, 'Take Me Home', 'images/music/home.jpg', '<iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/176034805&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>', 'music', 0),
(47, 'AsteROIDS!', 'images/programming/asteroids.png', '<div class="goodies">     <div class="center">         <span class="title">AsteROIDS!</span>         <br><br>         <img src="images/programming/asteroids.png" class="small">         <br><br>     </div>      <b>Description</b>:<br>AsteROIDS! is a online multiplayer game which utilizes websockets for the client-server communications.  I started working on this project with my brother to investigate a variety of different technologies.  The goal is to get this game to a state in which the underlying code created for the game engine and build pipeline can be easily migrated to another game down the road if we decide to follow through with another game.     <br><br>     <b>Technologies Used</b>:     <br>Angular     <br>Node.js     <br>Socket.IO     <br>MongoDB     <br>Grunt     <br>Karma     <br>Jasmine     <br><br><br>     <a href="https://github.com/codyseibert/sidescroller" target="_blank"><img src="images/github.png" class="github"> GitHub</a> </div>', 'programming', 9);
